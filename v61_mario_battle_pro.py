...
# --- V61 - "MARIO BATTLE PRO MASTER FIXED" ---
# Features:
# - FIXED COUNTDOWN: Correctly triggers when both players are ready.
...
# --- NETWORK ---
class FirebaseManagerV61:
    def __init__(self, db_url):
        self.db_url = db_url.rstrip('/')
        self.room_id = "battle_v61_pro"
...
class TetrisV61:
    def __init__(self):
        ...
        pygame.display.set_caption("MARIO BATTLE PRO MASTER V61")
        self.clock = pygame.time.Clock()
        self.fb = FirebaseManagerV61("https://mario-tetris-game-default-rtdb.firebaseio.com/")
    ...
    def draw(self):
        ...
        if self.mode == "menu":
            self.draw_t("MARIO BATTLE PRO MASTER V61", self.huge, (255,255,255), WW//2, 200)
...
if __name__ == "__main__":
    try: asyncio.run(TetrisV61().run())
    except:
        with open(f"crash_v61_{PID}.txt", "w") as f: f.write(traceback.format_exc())
        input("CRASH")

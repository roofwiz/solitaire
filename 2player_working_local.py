...
def log(msg):
    ...
    print(f"[TAGGED-LOCAL] {msg}")

log("Application starting...")

class FirebaseManagerLocalWorking:
...
class TetrisLocalWorking:
    def __init__(self):
        ...
        self.fb = FirebaseManagerLocalWorking("https://mario-tetris-game-default-rtdb.firebaseio.com/")
    ...
    def draw(self):
        ...
        if self.mode == "menu":
            self.screen.blit(self.font.render("2-PLAYER LOCAL WORKING", True, (255,255,255)), (100, 100))
...
if __name__ == "__main__":
    try: asyncio.run(TetrisLocalWorking().run())
    except: 

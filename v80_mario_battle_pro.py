...
# --- V80 - "MARIO BATTLE PRO MASTER (STABILITY FIX)" ---
# Technical Specs:
...
# - FIXED: Resolved syntax error in color mapping.
...
class BattleNetwork:
    def __init__(self, db_url):
        ...
        self.room_id = "battle_v80_pro_deploy"
...
class MarioBattlePro:
    def __init__(self):
        ...
        pygame.display.set_caption("MARIO BATTLE PRO MASTER V80")
                ...
                if self.phase == "play":
                    ...
                    if not self.net.game_over:
                        if self.clearing_rows:
                            ...
                            c_id_char = {'I':'1','O':'2','T':'3','S':'4','Z':'5','J':'6','L':'7'}[self.piece['id']]
    ...
    def draw_frame(self):
        ...
        if self.phase == "menu":
            ...
            self.draw_t("COMPETITIVE STABLE BUILD v80", self.f_s, (255, 255, 0), WW//2, 350)
